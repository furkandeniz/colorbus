...
# BusQueue scene check, a WaitingArea scene check, and a level
# loading/validation check. Exits 0 only if every gating check passes.
set -uo pipefail
...
echo "-- Step 1/11: headless import --"
